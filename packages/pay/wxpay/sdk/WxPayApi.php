...
use Packages\Pay\Wxpay\Sdk\WxPayException;
use Packages\Pay\Wxpay\Sdk\WxPayConfig;
use Packages\Pay\Wxpay\Sdk\WxPayDataBase;
...
class WxPayApi
{
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, base_path(WxPayConfig::SSLCERT_PATH));
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY,base_path(WxPayConfig::SSLKEY_PATH));
		}
		//post提交方式
