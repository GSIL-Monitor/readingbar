...
use Readingbar\Teacher\Backend\Models\favorites;
use Readingbar\Teacher\Backend\Models\Books;
use Readingbar\Teacher\Backend\Models\BookAttach;
...
class FavoritesController extends Controller
{
   ...
   public function index(){
   		...
   		return view("Readingbar/teacher/backend::favorites_list",$data);
   }
