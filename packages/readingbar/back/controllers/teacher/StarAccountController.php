...
class StarAccountController extends BackController
{
   ...
   public function index(){
   		...
   		return $this->view("teacher.staraccount",$data);
   }
   //获取star账号列表
   public function accountsList(Request $request){
   		...
   		->where(function($where) use($request){
   			...
   			if($request->input('star_account')!=null){
   				$where->where('star_account','like','readingbar'.$request->input('star_account').'%');
   			}
