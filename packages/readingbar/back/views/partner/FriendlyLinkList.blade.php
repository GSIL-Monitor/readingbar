			...
			<div class="col-md-12">
				<div class="ibox float-e-margins">
	                        <div class="ibox-title">
	                            <h5>{{ trans('FriendlyLink.view_list') }}</h5>
	                        </div>
	                                ...
	                                <div class="col-sm-3">
	                                    <form class="input-group"  onsubmit="return false">
	                                    	...
	                                    	<span class="input-group-btn">
	                                        	...
	                                        	<a class="btn btn-sm btn-default" href="{{ url('admin/partner/friendlyLink/form') }}"><i class="fa fa-plus"></i></a>
				                  ...
				                  <th>{{ trans('FriendlyLink.columns.operation') }}</th>
					                ...
					                <tbody>
						                 <tr v-if="list" v-for="d in list.data">
						                   ...
						                   <td>[[ d.updated_at ]]</td>
						                   <td>
						                   		<a :href="d.edit" class="btn btn-default">{{ trans('FriendlyLink.btns.edit') }}</a>
						                   </td>
						                </tr>
					                </tbody>
	                                </table>
		...
		var mainContent=new Vue({
			...
			methods:{
				...
				doGetList:function(){
					var _this=this;
					$.ajax({
						url:"{{ url('admin/partner/friendlyLink/getList') }}",
						dataType:"json",
						data:_this.search,
						beforeSend:function(){
				...
				doDelete:function(){
					var _this=this;
					$.ajax({
						url:"{{ url('admin/partner/friendlyLink/delete') }}",
						dataType:"json",
