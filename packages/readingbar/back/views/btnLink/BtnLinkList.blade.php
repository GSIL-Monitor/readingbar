			...
			<div class="col-md-12">
				<div class="ibox float-e-margins">
	                        <div class="ibox-title">
	                            <h5>{{ trans('BtnLink.view_list') }}</h5>
	                        </div>
	                        <div class="ibox-content">
	                            <div class="row">
	                                <div class="col-sm-3" onsubmit="return false">
	                                    <form class="input-group">
	                                    	...
	                                    	<span class="input-group-btn">
	                                        	...
	                                        	<a class="btn btn-sm btn-default" href="{{ url('admin/btnLink/form') }}"><i class="fa fa-plus"></i></a>
				                  ...
				                  <th>{{ trans('BtnLink.columns.operation') }}</th>
					                ...
					                <tbody>
						                 <tr v-if="list" v-for="d in list.data">
						                   ...
						                   <td>[[ d.updated_at ]]</td>
						                   <td>
						                   		<a :href="d.edit" class="btn btn-default">{{ trans('BtnLink.btns.edit') }}</a>
						                   </td>
						                </tr>
					                </tbody>
	                                </table>
