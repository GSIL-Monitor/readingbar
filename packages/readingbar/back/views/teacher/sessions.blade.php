...
<link href="{{ asset('/assets/css/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
<script src="{{ asset('/assets/js/plugins/moment/moment.min.js')}}"></script>
<script src="{{ asset('/assets/js/plugins/moment/local/zh-cn.js')}}"></script>
