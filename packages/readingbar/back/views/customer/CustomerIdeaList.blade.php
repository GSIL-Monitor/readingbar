			...
			<div class="col-md-12">
				<div class="ibox float-e-margins">
	                        <div class="ibox-title">
	                            <h5>{{ trans('CustomerIdea.view_list') }}</h5>
	                        </div>
	                                ...
	                                <div class="col-sm-3">
	                                    <form class="input-group" onsubmit="return false">
	                                    	...
	                                    	<span class="input-group-btn">
	                                        	...
	                                        	<a class="btn btn-sm btn-default" href="{{ url('admin/customer/idea/form') }}"><i class="fa fa-plus"></i></a>
	                            ...
	                            <div class="table-responsive">
				                  ...
				                  <th>
				                 	<a href="javascript:void(0)" class="control-label order-id" style="margin-bottom: 0px" v-on:click="orderBy('id')">
				                 		...
				                 		{{ trans('CustomerIdea.columns.id') }}
				                 	</a>
				                  </th>
				                   <th>
				                 	<a href="javascript:void(0)" class="control-label order-member_id" style="margin-bottom: 0px" v-on:click="orderBy('member_id')">
				                 		<i class="fa fa-sort"></i>
				                 		{{ trans('CustomerIdea.columns.member_id') }}
				                 	</a>
				                  </th>
				                   <th>
				                 	<a href="javascript:void(0)" class="control-label order-idea" style="margin-bottom: 0px" v-on:click="orderBy('idea')">
				                 		<i class="fa fa-sort"></i>
				                 		{{ trans('CustomerIdea.columns.idea') }}
				                 	</a>
				                  </th>
				                  
				                   <th>
				                 	<a href="javascript:void(0)" class="control-label order-reply" style="margin-bottom: 0px" v-on:click="orderBy('reply')">
				                 		<i class="fa fa-sort"></i>
				                 		{{ trans('CustomerIdea.columns.reply') }}
				                 	</a>
				                  </th>
				                  <th>
				                 	<a href="javascript:void(0)" class="control-label order-show_status" style="margin-bottom: 0px" v-on:click="orderBy('show_status')">
				                 		<i class="fa fa-sort"></i>
				                 		{{ trans('CustomerIdea.columns.show_status') }}
				                 	</a>
				                  </th>
				                  <th>
				                 	<a href="javascript:void(0)" class="control-label order-created_at" style="margin-bottom: 0px" v-on:click="orderBy('created_at')">
				                 		<i class="fa fa-sort"></i>
				                 		{{ trans('CustomerIdea.columns.created_at') }}
				                 	</a>
				                  </th>
				                  <th>
				                 	<a href="javascript:void(0)" class="control-label order-updated_at" style="margin-bottom: 0px" v-on:click="orderBy('updated_at')">
				                 		<i class="fa fa-sort"></i>
				                 		{{ trans('CustomerIdea.columns.updated_at') }}
				                 	</a>
				                  </th>
				                  <th>{{ trans('CustomerIdea.columns.operation') }}</th>
				                </thead>
					                <tbody>
						                 <tr v-if="list" v-for="d in list.data">
						                   ...
						                   <td>[[ d.updated_at ]]</td>
						                   <td>
						                   		<a :href="d.edit" class="btn btn-default">{{ trans('CustomerIdea.btns.edit') }}</a>
						                   </td>
						                </tr>
					                </tbody>
	                                </table>
		...
		var mainContent=new Vue({
			...
			methods:{
				...
				doGetList:function(){
					var _this=this;
					$.ajax({
						url:"{{ url('admin/customer/idea/getList') }}",
						dataType:"json",
						data:_this.search,
						beforeSend:function(){
				...
				doDelete:function(){
					var _this=this;
					$.ajax({
						url:"{{ url('admin/customer/idea/delete') }}",
						dataType:"json",
