		...
		<div class="col-lg-12">
		    <div class="ibox">
		    	<div class="ibox-title">
                        <h5><i class="fa fa-list-ul"></i>折扣类型列表</h5>
		            ...
		            <table class="footable table table-stripped toggle-arrow-tiny default breakpoint footable-loaded" data-page-size="15">
		                ...
		                <tbody>
		                    <tr class="footable-even" style="display: table-row;" v-for="n in notices.data">
		                        ...
		                        <td class="footable-visible">[[n.days]]</td>
		                        <td class="footable-visible">[[n.memo]]</td>
		                        <td class="footable-visible">[[n.get_rule]]</td>
...
var noticesList=new Vue({
	...
	data:{
		...
		a:{
			create:"{{url('admin/discount/type/form')}}"
		},
		selected:[],
		alert:null
	},
	methods:{
		...
		doGetnotices:function(){
			...
			$.ajax({
				url:"{{ url('admin/api/discount/type/getDiscountTypes') }}",
				data:_this.search,
				dataType:"json",
		...
		doDelete:function(){
			if(confirm('是否确认删除！')){
				var _this=this;
				$.ajax({
					url:"{{ url('admin/api/discount/type/deleteDiscountType') }}",
