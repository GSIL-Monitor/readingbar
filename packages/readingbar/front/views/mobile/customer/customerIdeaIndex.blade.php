		...
		<div class="content650 text-center">
			...
			<template v-for="i in ideas.data">
				<div class="conpent-textarea-width-fixed row">
					<div class="col-xs-12 i-name am-text-left">[[ i.nickname ]]:</div>
					<div class="col-xs-12">
						<div class="col-xs-1 "></div>
						<div class="col-xs-10 i-content am-text-left">[[ i.idea ]]</div>
						<div class="col-xs-1 "></div>
					</div>
					<div class="col-xs-12 i-dateline am-text-right ">[[ i.created_at ]]</div>
				</div>
