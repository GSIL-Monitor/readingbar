 ...
 <br><br>
			 <img src="{{ asset('home/wap/images/wap20170523/product/detail-icon7.png') }}" class="product-icon-300 margin10">
			    <img src="{{ asset('home/wap/images/wap20170523/product/detail-icon6.png') }}" class="product-icon-300 margin10">
			     <img src="{{ asset('home/wap/images/wap20170523/product/detail-icon1.png') }}" class="product-icon-300 margin10">
			      <img src="{{ asset('home/wap/images/wap20170523/product/detail-icon4.png') }}" class="product-icon-300 margin10">
			      <img src="{{ asset('home/wap/images/wap20170523/product/detail-icon3.png') }}" class="product-icon-300 margin10">
<br><br> 
   <div class="component-green-tbox font_content_g">
			     	<div class="box">
			     		<div>
			     			<p>价值11988元/年  现价7988元/年</p>
							<p>在定制阅读基础上，增加纯欧美外教1对1 Talking bar</p>
						</div>
						<em class="btn-img">
			  ...
			  <div class="component-green-tbox font_content_g">
			   ...
			   <div class="product-table row">
						  	 	...
						  	 	<div class="col-xs-5">
									...
									<ul>
										...
										<li>每次Talking Bar前，挑选一本定制阅读书籍，需提前预约。</li>
			   ...
			   <br style="clear:both"><br>
			   		@if(auth('member')->isLoged())
			   			<a href="javascript:void(0)" class="btn-local"  data-am-modal="{target: '#doc-modal-1', closeViaDimmer: 0}" v-on:click="setProduct(9)">
