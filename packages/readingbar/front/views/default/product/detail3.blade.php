    ...
    <div class="content  " >
      <div class="container cont-about container-2017" style="background-color:white">
		      ...
		      <div class="content940 text-center">
		      	<p class=" font_title_b">选择适合自己的原版书，让阅读不再盲目</p>
				<p class="pd15 font_title_b">18万本原版书阅读理解测试，让阅读明明白白</p>
		      </div>
		      <div class="content940 text-center">
		      	<br>
		      	<img alt="" src="{{ asset('home/pc/images/products/detail_icon3.png')}}">
		      </div>
		      <br><br><br><br>
			  ...
			  <div class="text-center">
			   ...
			   <div class="content940 text-center">
			   		...
			   		@if(auth('member')->isLoged())
			   			<a href="javascript:void(0)" class="btn-local" data-toggle="modal" data-target="#protocolModal" v-on:click="setProduct(3)">
