    ...
    <div class="content  " >
      <div class="container cont-about container-2017" style="background-color:white">
		      ...
		      <div class="content940 text-center">
		      	<p class=" font_title_b">每年100本+原版书，阅读的开始</p>
				<p class="pd15 font_title_b">纯欧美外教1对1 Talking Bar，让阅读更圆满</p>
		      </div>
		      <div class="content940 text-center">
		      	<br>
		      	<img alt="" src="{{ asset('home/pc/images/products/detail_icon2.png')}}">
		      </div>
		      <br><br><br><br>
			  ...
			  <div class="text-center">
			   ...
			   <div class="content940 text-center">
			   		...
			   		@if(auth('member')->isLoged())
			   			<a href="javascript:void(0)" class="btn-local" data-toggle="modal" data-target="#protocolModal" v-on:click="setProduct(9)">
