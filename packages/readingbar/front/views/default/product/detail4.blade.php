    ...
    <div class="content  " >
      <div class="container cont-about container-2017" style="background-color:white">
		      ...
		      <div class="content940 text-center">
		      	<p class=" font_title_b">给孩子的阅读进行专业定级</p>
				<p class="pd15 font_title_b">实现全年阅读能力成长监控</p>
		      </div>
		      <div class="content940 text-center">
		      	<br>
		      	<img alt="" src="{{ asset('home/pc/images/products/detail_icon4.png')}}">
		      </div>
		      <br><br><br><br>
			  ...
			  <div class="text-center">
			   ...
			   <div class="content940 text-center">
			   		...
			   		@if(auth('member')->isLoged())
			   			<a href="javascript:void(0)" class="btn-local" data-toggle="modal" data-target="#protocolModal" v-on:click="setProduct(10)">
