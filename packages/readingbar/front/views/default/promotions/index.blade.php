			...
			<div class="content mgl-40">
                ...
                <div class="row promotion padding30">
					...
					<div class="col-md-6 fl promotion-tj01">
						...
						<div id="pro-pay-info">
							<span><em class="pro-ys-01"></em><b>总订单：<a href="javascript:void(0)" v-on:click="doGetList('ordersList',0)">[[dashboard.total_orders]]</a></b></span>
							<span><em class="pro-ys-02"></em><b>已支付订单：<a href="javascript:void(0)" v-on:click="doGetList('ordersList',1)">[[dashboard.total_hp_orders]]</a></b></span>
							<span><em class="pro-ys-03"></em><b>未支付订单：<a href="javascript:void(0)" v-on:click="doGetList('ordersList',2)">[[dashboard.total_hnp_orders]]</a></b></span>
						</div>
					</div>
				</div>
	    ...
	    series : [
	        {
	           ...
	           radius : '75%',
	            ...
	            data:[
	                ...
	                {value:arguments[0], name:'已支付订单'},
	                {value:arguments[1], name:'未支付订单'}
	            ],
	            itemStyle: {
	                emphasis: {
	                    shadowBlur: 2,
