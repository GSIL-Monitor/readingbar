	             ...
	             <ul class="nav nav-tabs">
					...
					<div class="content mgl-40">
						<form id="baseinfoForm" class="mgl-40 mgb-20" action="http://account.cowinhome.com/index.php?route=pcuser/manage/baseinfo" method="post">
							...
							<div class="row">
								<div class="input-column col-md-3">手机：</div>
								<div class="input-value col-md-9">
									<input v-model="info.mobile" type="text">
								</div>
							</div>
							<div class="row">
								<div class="input-column col-md-3">验证码：</div>
								<div class="input-value col-md-9 inline">
									<input v-model="info.code" type="text">
									<a v-on:click="doSendMobileCode()" onclick="return false;" class="btn btn-default fz-14">发送验证码</a>
								</div>
							</div>
							<div class="row">
						...
						<script type="text/javascript">
							new Vue({
								...
								data:{
									ajaxUrls:{
										submitUrl:"{{ url('api/member/modify/mobile') }}",
										sendMobileCode:"{{ url('api/message/sendMobileCode') }}",
									},
									info:{
										mobile:"{{ auth('member')->member->cellphone }}",
										code:null
									}
								},
								methods:{
