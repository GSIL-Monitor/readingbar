...
@section('content')
   ...
   <style>
    ...
    <div class="content paddbt70 " >
    	<div class="container">
	    	<div class="row">
						<div class="col-xs-12">
							<ul class="nav nav-local1 font-16 color333333">
							  <li role="presentation"  style="width:20%;display:inline-block" class="active" ><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab" >STAR测评流程</a></li>
							  <li role="presentation"  style="width:20%;display:inline-block" class=""><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab" >STAR测评QA</a></li>
							  <li role="presentation"  style="width:20%;display:inline-block" class=""><a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab" >AR测试流程 </a></li>
							  <li role="presentation"  style="width:20%;display:inline-block" class=""><a href="#tab4" aria-controls="tab4" role="tab" data-toggle="tab" > AR测试QA</a></li>
							  <li role="presentation"  style="width:20%;display:inline-block" class=""><a href="#tab5" aria-controls="tab5" role="tab" data-toggle="tab" > 根据STAR测评选书</a></li>
							</ul>
						</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 color4bd2bf">
					STAR测评：英文阅读能力测评   AR测试：原版书阅读理解测试
				</div>
			</div>
		</div>
		<br>
      <div class="container cont-about container-2017" style="background-color:white">
      		<div class="tab-content">
			    <div role="tabpanel" class="tab-pane active text-center" id="tab1">
					   <img src="{{url('home/pc/images/page1/star_01.png')}}">
					   <img src="{{url('home/pc/images/page1/star_02.png')}}">
					   <img src="{{url('home/pc/images/page1/star_03.png')}}">
					   <img src="{{url('home/pc/images/page1/star_04.png')}}">
					   <img src="{{url('home/pc/images/page1/star_05.png')}}">
					   <img src="{{url('home/pc/images/page1/star_06.png')}}">
					   <img src="{{url('home/pc/images/page1/star_07.png')}}">
					  
				</div>
			    <div role="tabpanel" class="tab-pane" id="tab2">
						<div class="page-nr content910">
							<b class="color4bd2bf">1、购买产品后，测试账号何时能收到？</b>
							<p>购买后，1个工作日内账号会发送至注册邮箱，同时有短信提醒。</p>
							<br>
							<b class="color4bd2bf">2、购买产品后，该做些什么？</b>
							<p>尽快完成第一次STAR测评--1个工作日后到官网【个人中心】查看中英文解读报告--等待专属导师主动致电答疑--为孩子自行准备AR分级读物--阅读书籍后进行AR测试。（服务有效期内随时联系专属导师咨询相关问题）</p>
							<br>
							<b class="color4bd2bf">3、暑假期间购买产品，注册时年级填写哪一个？</b>
							<p>每年8月1日，蕊丁吧网站注册会员的孩子年级全部自动升一级！自8月2日起，请所有新注册会员一定要填写9月开学后的新年级。（我们将根据家长填写的实际年级发送对应年级的系统账号，所以这个信息很重要哦。）</p>
							<br>
							<b class="color4bd2bf">4、STAR测评账号是哪个？</b>
							<p>您邮箱收到的账号，readingbar****。</p>
							<br>
							<b class="color4bd2bf">5、账号可以多人使用吗？</b>
							<p>不可以，测评账号严格遵守“一人一号”的原则，多人使用存在被封停账号的风险，影响测评的准确性。</p>
							<br>
							<b class="color4bd2bf">6、测评时需要有人监督吗？</b>
							<p>首次评测时，请为孩子提供安静的环境，帮助他适应线上测评的方式，而且最好监督测评全过程，避免测评时间过长。</p>
							<br>
							<b class="color4bd2bf">7、父母可以帮忙测评吗？</b>
							<p>不可以，会影响测评结果的准确性。</p>
							<br>
							<b class="color4bd2bf">8、一年三次STAR测评如何安排比较合理？</b>
							<p>购买初期，安排第一次测评，以后半年一次即可。</p>
							<br>
							<b class="color4bd2bf">9、STAR测评有多少道题目？</b>
							<p>34道正式测试题目+7道范例测试题目。每次使用STAR测评系统，会有7道范例测试题目，目的是为了确保孩子已经具备使用这套系统的能力，还可以让孩子在进入正式测试前做好准备，了解测试形式。</p>
							<br>
							<b class="color4bd2bf">10、STAR测评位置在哪里？</b>
							<p>官网首页【测评入口】</p>
						    <br>
							<b class="color4bd2bf">11、STAR测评有APP吗？</b>
							<p>暂时没有APP，建议您使用电脑完成测试。</p>
							<br>
							<b class="color4bd2bf">12、STAR测评的结果准确吗？</b>
							<p>测评题目建立在30年大数据统计基础之上，会根据孩子的阅读水平自动调整难易度，是目前最为科学、专业的阅读能力测评系统，仅一次测评并不能完全反映实际水平，我们将结合AR测试统计数据提供阶段性分析和阅读建议。</p>
							<br>
							<b class="color4bd2bf">13、STAR测评完成后，为什么没显示结果？</b>
							<p>测评结果只能从后台查看，专属导师会帮您解读。</p>
							<br>
							<b class="color4bd2bf">14、STAR测评中断了，需要输入的password是什么？</b>
							<p>admin</p>
							<br>
							<b class="color4bd2bf">15、完成STAR测评后，什么时候能收到报告？</b>
							<p>STAR测评1个工作日后，可以在官网【个人中心】查询报告。专属导师上传报告时会有短信提醒，请注意查看。</p>
							<br>
							<b class="color4bd2bf">16、我的专属导师是谁？如何联系?</b>
							<p>第一次STAR测评完成后，专属导师会在上传报告后1个工作日内主动致电答疑；如您暂时不需要进行STAR测评，请直接拨打400-625-9800找客服备注测试账号（readingbar开头的），老师会主动致电和您建立联系。</p>
							<br>
							<b class="color4bd2bf">17、平时，如何和专属导师联系？</b>
							<p>我们建议您添加专属导师工作微信，这是最方便有效的联系方式。</p>
							<br>
							<b class="color4bd2bf">18、STAR测评报告中的各种指数都是什么意思？</b>
							...
							<br>
							<b class="color4bd2bf">19、STAR测评结果不准确怎么办？</b>
							<p>如果确实因孩子的状态不佳或者某些误操作造成的结果不准确，可以联系专属导师，沟通情况后，申请进行重测。</p>
							<br>
							<b class="color4bd2bf">20、如何设置阅读目标？</b>
							<p>使用测试系统一个月后，可主动联系专属导师，协助您设置阅读目标。</p>
							<br>
							<b class="color4bd2bf">21、根据STAR测评结果中的哪个数值选择书籍？</b>
							<p>ZPD</p>
							<br>
							<b class="color4bd2bf">22、在哪个网站搜索和查询书籍相关信息？</b>
							<p>http://www.arbookfind.com</p>
							<br>
							<b class="color4bd2bf">23、在www.arbookfind.com找书时，ATOS Book Level填什么？</b>
							<p>填写STAR测评报告中的ZPD数值范围</p>
							<br>
							<b class="color4bd2bf">24、STAR测评和AR测试用的是同一个账号吗？</b>
							<p>是的，在同一个测评入口登陆后，再选择STAR或AR。</p>
							<br>
							<b class="color4bd2bf">25、我的密码忘记了怎么办？</b>
							<p>请您联系专属导师或拨打客服热线400-625-9800咨询。</p>
							<br>
							<b class="color4bd2bf">26、我的账户被锁住了怎么办？</b>
							<p>被锁住的账户24小时后自动解锁。</p>
			    ...
			    <div role="tabpanel" class="tab-pane" id="tab3">
						<img src="{{url('home/pc/images/page3/AR_02.jpg')}}" class="mautoimg">
						<img src="{{url('home/pc/images/page3/AR_03.jpg')}}" class="mautoimg">
						<img src="{{url('home/pc/images/page3/AR_04.jpg')}}" class="mautoimg">
						<img src="{{url('home/pc/images/page3/AR_05.jpg')}}" class="mautoimg">
						<img src="{{url('home/pc/images/page3/AR_06.jpg')}}" class="mautoimg">
						<img src="{{url('home/pc/images/page3/AR_07.jpg')}}" class="mautoimg">
						<img src="{{url('home/pc/images/page3/AR_08.jpg')}}" class="mautoimg">
				</div>
			    <div role="tabpanel" class="tab-pane" id="tab4">
						...
						<b class="color4bd2bf">3、暑假期间购买产品，注册时年级填写哪一个？</b>
							<p>每年8月1日，蕊丁吧网站注册会员的孩子年级全部自动升一级！自8月2日起，请所有新注册会员一定要填写9月开学后的新年级。（我们将根据家长填写的实际年级发送对应年级的系统账号，所以这个信息很重要哦。）</p>
						<br>
						<b class="color4bd2bf">4、AR测试和STAR测评是同一个账号吗？</b>
							<p>是的，在同一个测评入口登陆后，再选择STAR或AR。</p>
						<br>
						<b class="color4bd2bf">5、AR测试一年有多少次？</b>
							<p>无限次，根据实际情况使用，使用频率越多，对孩子的英文阅读能力提升越有益。</p>
						<br>
						<b class="color4bd2bf">6、AR测试如何在手机建立快捷方式？</b>
						...
						<br>
						<b class="color4bd2bf">16、在哪个网站搜索和查询AR分级读物相关信息？</b>
							<p>http://www.arbookfind.com</p>
						<br>
						<b class="color4bd2bf">17、在www.arbookfind.com找书时，ATOS Book Level填什么？</b>
							<p>填写STAR测评报告中的ZPD数值范围</p>
						<br>
						<b class="color4bd2bf">18、我的专属导师是谁？如何联系?</b>
							<p>第一次STAR测评完成后，专属导师会在上传报告后1个工作日内主动致电答疑；如您暂时不需要进行STAR测评，请直接拨打400-625-9800找客服备注测试账号（readingbar****），老师会主动致电与您建立联系。</p>
						<br>
						<b class="color4bd2bf">19、平时，如何和专属导师联系？</b>
							<p>我们建议您添加专属导师工作微信，这是最方便有效的联系方式。</p>
						<br>
						<b class="color4bd2bf">20、我的密码忘记了怎么办？</b>
							<p>请您联系专属导师或拨打客服热线400-625-9800咨询。</p>
						<br>
						<b class="color4bd2bf">21、我的账户被锁住了怎么办？</b>
							<p>被锁住的账户24小时后自动解锁。</p>
			    ...
			    <div role="tabpanel" class="tab-pane" id="tab5">
					<div class="content742 row ">
						<div class="text-center font_content_g color333333">如何根据阅读能力测评数据为孩子选择适合的原版书呢？</div>
						<br><br>
						<div class="four-horn-tbox">
							<div class="font_content_s">为您介绍一款超级实用能查找原版书分级的AR BOOKFIND系统</div>
							<div class="font_content_s">关键是~~</div>
							<div class="font_content_s color4bd2bf">不花钱！不花钱！不花钱！</div>
							<div class="font_content_s">重要的事情说三遍~</div>
							<div class="font_content_s">一起来看看这个网站吧</div>
							<div class="font_content_s">首先</div>
							<div class="font_content_s">打开它的首页网址：<a href="http://www.arbookfind.com/">http://www.arbookfind.com/</a></div>
							
						</div>
						<br><br>
						<div class="font_title_ddd color4bd2bf text-center">AR BOOKFIND</div>
						<br><br>
						
					</div>
					<div class="content910">
						<div class="font_title_left_circle">AR BOOKFIND</div>
						<br><br>
					</div>
					<div class="content910 text-center">
					...
					<div class="content742 row ">
						<div class="four-horn-tbox">
							...
							<br>
							<div class="font_content_s color4bd2bf">其中各种指数为</div>
							<div class="font_content_s color4bd2bf">LG K-3=幼儿园至小学三年级</div>
							<div class="font_content_s color4bd2bf">MG 4-8=四年级至八年级</div>
							<div class="font_content_s color4bd2bf">MG+6 and up =六年级以上</div>
							<div class="font_content_s color4bd2bf">UG 9-12=九至十二年级</div>
							<br>
					...
					<div class="content742 row ">
						<div class="conpent-bcg-tbox">
							...
							<div class="font_content_s"><img alt="" src="{{ asset('home/pc/images/icon-down.png')}}"></div>
					...
					<div class="content742 row ">
						<div class="conpent-man-tbox">
							...
							<div class="font_content_s">AR BOOKFIDN网站目前收录<span class="color4bd2bf">18万册原版书</span>相关数据</div>
							<div class="font_content_s">且这个数量还在定期不断增加</div>
							<div class="font_content_s">免费查询</div>
							<div class="font_content_s">随时查询</div>
							<div class="font_content_s">让阅读不再盲目</div>
							<div class="font_content_s">科学阅读找蕊丁吧~</div>
						</div>
					</div>
				</div>
			  </div>
