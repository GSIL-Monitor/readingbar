	  ...
	  <!--/ home-column-fl end-->
	   <div class="col-md-10 home-column-fr100" >
	        <ul class="nav nav-tabs">
				<li role="presentation" class="active"><a href="#">我的书单</a></li>
			</ul>
					...
					<tbody>
						<tr v-for="d in readPlan.details">
							...
							<td class="color66" style="min-width:100px">
								<a v-if="readPlan.status>=1" href="javascript:void(0)" v-on:click="goCommentForBook(d.id)">查看>></a>
								<span v-else>暂无</span>
							</td>
						</tr>
					</tbody>
	...
	var ReadPlanDetail=new Vue({
		...
		methods:{
			goCommentForBook:function(bid){
				var url="{{url('book/comment')}}?student_id="+this.readPlan.for+"&book_id="+bid;
