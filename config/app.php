...
return [
    ...
    */
    ...
    'providers' => [
	    ...
	    Readingbar\Bookmanager\BookmanagerProvider::class,
	    Readingbar\Readinginstruction\ReadinginstructionProvider::class,
	    Readingbar\Member\MemberProvider::class,
	    Readingbar\Account\AccountProvider::class,
	    Readingbar\Book\BookProvider::class,
	    Readingbar\Survey\SurveyProvider::class,
	    Readingbar\Bookcomment\BookcommentProvider::class,
	    Readingbar\Common\CommonProvider::class,
    	Readingbar\Back\BackServiceProvider::class,
	    Readingbar\Front\FrontServiceProvider::class,
	    Readingbar\Api\ApiServiceProvider::class,
    	Packages\Pay\PayProvider::class,
    ...
    */
    ...
    'aliases' => [
    	...
    	'WxPay' => Packages\Pay\Facades\WxPayFacade::class,
